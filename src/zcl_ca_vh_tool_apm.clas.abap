...
CLASS zcl_ca_vh_tool_apm DEFINITION PUBLIC
                                    FINAL
                                    CREATE PUBLIC.
...
CLASS ZCL_CA_VH_TOOL_APM IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    zif_apack_manifest~descriptor =
         VALUE #(
            group_id        = 'itinere.at'
            artifact_id     = 'zca_tbx_value_help_tool'
            version         = '0.1.0'
            repository_type = 'abapGit'
            git_url         = 'https://github.com/JSB-Vienna/zca_tbx_value_help_tool.git'
            dependencies    =
                  VALUE #(
                      ( group_id       = 'itinere.at'
